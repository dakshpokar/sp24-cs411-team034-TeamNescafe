                      ...
                      <div className="relative mt-6 flex-1 px-4 sm:px-6">
                        ...
                        <div className="mt-4">
                          ...
                          <button
                            ...
                            class="text-black bg-red focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              fill="none"
